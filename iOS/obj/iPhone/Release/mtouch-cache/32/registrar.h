...
@class AppDelegate;
@class CapstoneProject_iOS_CustomMKAnnotationView;
...
@class CapstoneProject_iOS_CustomMapRenderer;
@class CapstoneProject_iOS_CustomMapRenderer2;
...
@class Plugin_PushNotification_PushNotificationManager;
...
@interface CapstoneProject_iOS_CustomMKAnnotationView : MKAnnotationView {
}
	-(void) release;
	-(id) retain;
	-(int) xamarinGetGCHandle;
...
@interface CapstoneProject_iOS_CustomMapRenderer : Xamarin_Forms_Maps_iOS_MapRenderer {
}
	-(id) init;
@end

@interface CapstoneProject_iOS_CustomMapRenderer2 : Xamarin_Forms_Maps_iOS_MapRenderer {
}
	-(id) init;
@end
...
@interface Plugin_PushNotification_PushNotificationManager : NSObject<UNUserNotificationCenterDelegate> {
}
	-(void) release;
	-(id) retain;
	-(int) xamarinGetGCHandle;
